...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    position: Attribute.Enumeration<['teacher', 'student', 'parent']>;
    firstName: Attribute.String;
    lastName: Attribute.String;
    ...
    courses: Attribute.Relation<
      ...
      'api::course.course'
    >;
    enrolled_courses: Attribute.Relation<
      'plugin::users-permissions.user',
      'manyToMany',
      'api::course.course'
    >;
...
export interface ApiCourseCourse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    subject: Attribute.Enumeration<
      ['english', 'science', 'thai', 'social', 'math', 'preschool']
    >;
    enrolled_students: Attribute.Relation<
      'api::course.course',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
...
export interface ApiModuleModule extends Schema.CollectionType {
  ...
  attributes: {
    ...
    type: Attribute.Enumeration<['article', 'audio', 'video', 'quiz']>;
...
export interface ApiProgressProgress extends Schema.CollectionType {
  ...
  attributes: {
    ...
    module: Attribute.Relation<
      ...
      'api::module.module'
    >;
    type: Attribute.Enumeration<['quiz', 'video', 'audio', 'article']>;
...
export interface ApiTeacherTeacher extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    bachelor_degree: Attribute.String;
    bachelor_major: Attribute.String;
    master_degree: Attribute.String;
    master_major: Attribute.String;
    subject: Attribute.String;
    bachelor_graduated: Attribute.String;
    master_graduated: Attribute.String;
